...
namespace JumpAPP.Views
{
    ...
    public partial class ThreeDayOrganiser : ContentPage
    {
        ...
        public Grid CreateGrid(DateTime date)
        {
            ...
            for (int i = 1; i < 25; i++)
            {
                ...
                // }
                grid.Children.Add(CreateLbl(), 1, (i - 1));
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                var filteredData = App.AppointmentResponse.Where(x => x.STARTIME.Date == currentDateTime.AddDays(i).Date);
