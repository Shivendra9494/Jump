    ...
    public class MPEntry : Entry
    {
        ...
        private void SetPlaceHolder()
        {
            if (!string.IsNullOrEmpty(BindingPath) && this.BindingContext != null)
            {
                ...
                if (_attributes != null)
                {
                    this.Placeholder = _attributes.DisplayName;
      ...
      BindableProperty.Create(nameof(BorderColor),
          typeof(Color), typeof(MPEntry), Color.Transparent);
        ...
        BindableProperty.Create(nameof(CornerRadius),
            typeof(double), typeof(MPEntry), Device.OnPlatform<double>(6, 7, 7));
        ...
        BindableProperty.Create(nameof(IsCurvedCornersEnabled),
            typeof(bool), typeof(MPEntry), true);
