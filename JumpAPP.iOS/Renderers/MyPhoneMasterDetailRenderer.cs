...
namespace JumpAPP.iOS.Renderers
{
    public class MyPhoneMasterDetailRenderer : UIViewController, IVisualElementRenderer, IEffectControlProvider
    {
        ...
        public void SetElement(VisualElement element)
        {
           ...
           // _clickOffView.BackgroundColor = new System.Drawing.Color().ToUIColor();
        ...
        {
            Element.Layout(new Xamarin.Forms.Rectangle(Element.X, Element.Y, size.Width, size.Height));
        }
        ...
        void LayoutChildren(bool animated)
        {
            ...
            MasterDetailPageController.MasterBounds = new Xamarin.Forms.Rectangle(0, 0, masterFrame.Width, masterFrame.Height);
            MasterDetailPageController.DetailBounds = new Xamarin.Forms.Rectangle(0, 0, frame.Width, frame.Height);
        ...
        void UpdateBackground()
        {
            ...
            else if (Element.BackgroundColor == Xamarin.Forms.Color.Default)
